...
void function CheckGround (arg_0) {
__asm{
	RETN 1
LOC_260:
	PUSHARG -2
...
void function WeatherObjectDeath () callsign 99 {
__asm{
	STACK 1
...
void function Battle2 () callsign 62 {
__asm{
	STACK 7
	RETN 0
...
void function EnterWar4 () callsign 64 {
__asm{
LOC_8B4:
	STACK 5
	PUSH 6
...
void function EnterWar5 () callsign 65 {
__asm{
LOC_1274:
	STACK 5
	PUSH 0
...
void function LoadingBattleMap (arg_0) callsign 50 {
__asm{
	PUSHARG -2
	JCOND 0, LOC_15C4
	JCOND 1, LOC_15CC
...
void function BattleYield (arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6) {
__asm{
LOC_173C:
	STACK 4
	PUSHARG -8
...
void function StartBattle (arg_0) callsign 51 {
__asm{
	STACK 10
	PUSH 3
	PUSH 1
...
void function AllRush () callsign 59 {
__asm{
	STACK 3
...
void function BattleEndTalk (arg_0) callsign 56 {
__asm{
	STACK 7
	PUSHINV 7 ; INTV_ATTACKER_GENERAL
	SYSCALL 0x206, (1 | (1 << 16)) ; GetGeneralType 
...
void function ReportResult (arg_0) callsign 6 {
__asm{
	PUSH 1
	DELAY
	PUSH 0
...
void function SearchTalk (arg_0) callsign 5 {
__asm{
LOC_2BB0:
	INST_09 1
	PUSH 0
...
void function KillGeneral () callsign 70 {
__asm{
	STACK 1
	PUSH 0
	PUSH 10
...
void function FreeGeneral () callsign 71 {
__asm{
	PUSH 0
	PUSHINV 7 ; INTV_ATTACKER_GENERAL
	PUSH 940
...
void function YieldGeneral (arg_0, arg_1) callsign 72 {
__asm{
	PUSH 1
	PUSH 2
	PUSHINV 8 ; INTV_DEFENDER_GENERAL
...
void function Test01 () callsign 98 {
__asm{
	PUSHINV 2 ; INTV_ATTACKER_MAJOR
	PUSH 0
	PUSH 10000
...
void function EnterMapMoveCamera (arg_0, arg_1, arg_2) callsign 58 {
__asm{
	STACK 7
	INST_09 2
	PUSH 0
...
void function MajorDeath (arg_0, arg_1) callsign 57 {
__asm{
	STACK 2
	PUSHARG -3
	PUSHSTR "Yell03"
...
void function EnterWarprep () callsign 54 {
__asm{
	PUSHSTR "MENU\\D0_*"
...
void function EnterBattle () callsign 55 {
__asm{
...
void function EnterMapmode () callsign 53 {
__asm{
	PUSH 0
	SETARG 2
	PUSHSTR "MENU\\D3*"
...
void function EnterPolicy () callsign 52 {
__asm{
	PUSHSTR "MENU\\S0*"
	SYSCALL 0x7, (1 | (0 << 16)) ; BatchLoadShape 
	PUSHSTR "MENU\\C3_B*"
